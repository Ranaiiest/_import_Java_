...
// it is better to use arraylist. linkedlist is used as deque in java. 
// we can use it as both stack and queue. it is better to use arraylist for stack and queue because of better performance.
...
public class learn_linkedlist {
    public static void main(String[] args) {
        ...
        // addFirst(val), addLast(val), removeFirst(), removeLast(), getFirst(), getLast() -> all these operations are O(1) 
        // in linkedlist
        prog_lang.addFirst("javascript");
        prog_lang.addLast("ruby");
        prog_lang.removeFirst();
        prog_lang.removeLast();
        String first_ele = prog_lang.getFirst();
        String last_ele = prog_lang.getLast();
